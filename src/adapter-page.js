...
(()=>{'use strict';if(window.__BANANE_V3_PAGE)return;
 ...
 const methods={ping:()=>({version:K.VERSION,pageId,label:cutLabel()}),state:snapshot,nativeSnapshot,capture,apply,restore,next,nextWithoutDecision,previousWithoutDecision,repriseGuard,validateAndNext,skipAndNext,
