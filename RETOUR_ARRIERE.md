...
```bash
git archive 155dbec | tar -x -C /tmp/banane-4.7.16
cd /tmp/banane-4.7.16 && python3 tools/package.py --output /tmp/banane-v4.7.16-test.zip
```
...
```bash
git archive d51c644 | tar -x -C /tmp/banane-4.7.11
cd /tmp/banane-4.7.11 && python3 tools/package.py --output /tmp/banane-v4.7.11-test.zip
```
