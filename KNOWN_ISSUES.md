...
|---|---|---|---|
| KI-024 | Élevée | Ouvert, essai Edge requis | L'équivalence entre `O2N3DCutNextInvalid3DRail` et le raccourci Maj+Z rapporté par l'opérateur n'est établie par aucune source du dépôt. La primitive de navigation sans décision de 4.7 utilise ce bouton et déclare la limite (`shortcutEquivalence.established: false`). Si l'action portait en réalité une décision ESV, le contrat « navigation sans décision » ne serait pas tenu et la primitive devrait changer. |
